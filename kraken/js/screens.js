ScreenHandler = function(_broadcaster, _world, _font) {
  this._canvas_handler = 0;
  this._menu_overlay = 0;
...
ScreenHandler.prototype.canvasCreated = function(vars) {  // we are obviously on screen 1, which introduces the player to the game.
  this._canvas_handler = vars[0];
  this._menu_overlay = new MenuOverlayScreen(this, this._broadcaster, this._game_world, this._font);
  this._current_screen = new StartScreen(this, this._broadcaster, this._game_world, this._font);
...
ScreenHandler.prototype.render = function() {
  ...
  if (this._menu_overlay != 0) {
    this._menu_overlay.render(this._canvas_handler._context);
  }
}

ScreenHandler.prototype.StartGame = function(vars) {
  this._current_screen = new GameScreen(this, this._broadcaster, this._game_world, this._font);
